...
<? if($access != 2) { ?>
              <li<? if(! $this->uri->segment(3) && $this->uri->segment(2) == 'partsryder') echo ' class="highlight active"'; ?>>
                <a href="/<?=$this->uri->segment(1)?>/partsryder/">
                  Order
                  <span class="childs"></span>
                </a>
              </li>
              <li<? if($this->uri->segment(3) == 'quote') echo ' class="highlight active"'; ?>>
                <a href="/<?=$this->uri->segment(1)?>/partsryder/quote">
                  Quote
                  <span class="childs"></span>
                </a>
              </li>
              <li<? if($this->uri->segment(3) == 'impress') echo ' class="highlight active"'; ?>>
                <a href="/<?=$this->uri->segment(1)?>/partsryder/impress">
                  Imprest Order
                  <span class="childs"></span>
                </a>
              </li>
              <li<? if($this->uri->segment(3) == 'sborder') echo ' class="highlight active"'; ?>>
                <a href="/<?=$this->uri->segment(1)?>/partsryder/sborder">
                  Request S&amp;B Order No.
                  <span class="childs"></span>
                </a>
              </li>
<? } ?>
<?/*
              ...
              <li<? if($this->uri->segment(3) == 'consumables') echo ' class="highlight active"'; ?>>
                <a href="/<?=$this->uri->segment(1)?>/partsryder/consumables">
                  Consumables
                  <span class="childs"></span>
                </a>
              </li>
 */?>
              <li<? if($this->uri->segment(3) == 'orders') echo ' class="highlight active"'; ?>>
                <a href="/<?=$this->uri->segment(1)?>/partsryder/orders">
                  View Orders
                  <span class="childs"></span>
                </a>
              </li>
<?/*
              <li<? if($this->uri->segment(3) == 'epc') echo ' class="highlight active"'; ?>>
                <a href="/<?=$this->uri->segment(1)?>/partsryder/epc">
                  EPC
                  <span class="childs"></span>
                </a>
              </li>
